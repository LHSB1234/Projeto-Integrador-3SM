...
<head>
    ...
    <title>Planilha de Registros</title>
    ...
    <div class="main-login">
        <div class="right-login">
            <div class="card-login">
                ...
                <h1>Planilha de Registros</h1>

                <table>
                    <tbody>
                        <?php include "exibir_registros.php"; ?>
                    </tbody>
                </table>

                <p><a href="../telahome/pagina_home.php">Voltar para a página inicial</a></p>
